...
read more aboutmultiple queues at [here](https://www.javaguides.net/2022/07/spring-boot-rabbitmq-multiple-queues.html)
...
To build the final jar and optimize the queueServices application for production, run:
